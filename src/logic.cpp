        ...
        void *logic_ptr)
{
    ...
    LogDebug(
            "Type: " << type << ", package: " << package << ", Event type: " << eventTypeStr(eventType) << ", Event state: " << eventStateStr(eventState) << ", progress: " << progress <<", error: " << error);
    (void) type;
    (void) progress;
    ...
    package == NULL) {
        ...
        LogDebug(
                "PackageInstalled Callback. Instalation of: " << package << ", error: " << error << ", progress: " << progress);
